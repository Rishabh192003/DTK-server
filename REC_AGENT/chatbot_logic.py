...
def send_chatbot_message(message):
    """Send message to user via your chatbot platform"""
    print(f"[CHATBOT] {message}")
    # Replace with your actual chatbot send function

def get_user_response():
    """Get user response from your chatbot platform"""
    response = input("User response (1/auto/yes for auto-remove, anything else for re-upload): ")
    return response
